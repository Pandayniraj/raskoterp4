...
Route::group(['middleware' =>  ['iptracker' , 'authorize']], function () {
    ...
    Route::group(['prefix' => 'admin'], function () {
        ...
        Route::post('adjustment-reason/edit/{id}',['as'=>'admin.adjustment-reason.update','uses'=>'AdjustmentReasonController@update']);
        ...
        Route::get('entries/excel/{label}/{id}', ['as' => 'admin.entries.excel', 'uses' => 'EntryController@DownloadExcel']);
        ...
        Route::get('division', ['as' => 'admin.division.index', 'uses' => 'DivisionController@index']);
        Route::get('division/create', ['as' => 'admin.division.create', 'uses' => 'DivisionController@create']);
        Route::post('division/create', ['as' => 'admin.division.store', 'uses' => 'DivisionController@store']);
        Route::get('division/edit/{id}', ['as' => 'admin.division.edit', 'uses' => 'DivisionController@edit']);
        Route::get('division/show/{id}', ['as' => 'admin.division.show', 'uses' => 'DivisionController@show']);
        Route::post('division/{id}', ['as' => 'admin.division.update', 'uses' => 'DivisionController@update']);
        Route::get('division/confirmdelete/{id}', ['as' => 'admin.division.confirm-delete', 'uses' => 'DivisionController@getModalDelete']);
        Route::get('division/delete/{id}', ['as' => 'admin.division.delete', 'uses' => 'DivisionController@destroy']);
        ...
        Route::post('city/edit/{id}',['as'=>'admin.city.update','uses'=>'CitymasterController@update']);
        ...
        Route::get('cities/modals', ['as' => 'admin.cities.modals.create',            'uses' => 'CitymasterController@showmodal']);
        Route::post('cities/modals', ['as' => 'admin.cities.citymodals',            'uses' => 'CitymasterController@postModal']);
        ...
        Route::get('localtax', ['as' => 'admin.localtax.index',            'uses' => 'LocaltaxController@index']);
        Route::get('localtax/create', ['as' => 'admin.localtax.create',            'uses' => 'LocaltaxController@create']);
        Route::post('localtax/', ['as' => 'admin.localtax.store',            'uses' => 'LocaltaxController@store']);
        Route::get('localtax/{Id}', ['as' => 'admin.localtax.show',             'uses' => 'LocaltaxController@show']);
        Route::get('localtax/approve/{Id}', ['as' => 'admin.localtax.approve',             'uses' => 'LocaltaxController@approve']);
        Route::get('localtax/{Id}/edit', ['as' => 'admin.localtax.edit',             'uses' => 'localtaxController@edit']);
        Route::post('localtax/{Id}', ['as' => 'admin.localtax.update',             'uses' => 'localtaxController@update']);
        Route::get('localtax/{id}/confirm-delete', ['as' => 'admin.localtax.confirm-delete',   'uses' => 'LocaltaxController@getModalDelete']);
        Route::get('localtax/{id}/delete', ['as' => 'admin.localtax.delete',           'uses' => 'LocaltaxController@destroy']);

        //Marriage Registration
        Route::get('marriage', ['as' => 'admin.marriage.index', 'uses' => 'MarriageRegistrationController@index']);
        Route::get('marriage/create', ['as' => 'admin.marriage.create', 'uses' => 'MarriageRegistrationController@create']);
        Route::post('marriage/store', ['as' => 'admin.marriage.store',            'uses' => 'MarriageRegistrationController@store']);
        Route::get('marriage/{Id}/edit', ['as' => 'admin.marriage.edit',             'uses' => 'MarriageRegistrationController@edit']);
        Route::post('marriage/{Id}', ['as' => 'admin.marriage.update',             'uses' => 'MarriageRegistrationController@update']);
        Route::get('marriage/{id}/confirm-delete', ['as' => 'admin.marriage.confirm-delete',   'uses' => 'MarriageRegistrationController@getModalDelete']);

        //Birth Registration
        Route::get('birth', ['as' => 'admin.birth.index', 'uses' => 'BirthRegistrationController@index']);
        Route::get('birth/create', ['as' => 'admin.birth.create', 'uses' => 'BirthRegistrationController@create']);
        Route::post('birth/store', ['as' => 'admin.birth.store',            'uses' => 'BirthRegistrationController@store']);
        Route::get('birth/{Id}/edit', ['as' => 'admin.birth.edit',             'uses' => 'BirthRegistrationController@edit']);
        Route::post('birth/{Id}', ['as' => 'admin.birth.update',             'uses' => 'BirthRegistrationController@update']);
        Route::get('birth/{id}/confirm-delete', ['as' => 'admin.birth.confirm-delete',   'uses' => 'BirthRegistrationController@getModalDelete']);

        //Death Registration
        Route::get('death', ['as' => 'admin.death.index', 'uses' => 'DeathCertificateController@index']);
        Route::get('death/create', ['as' => 'admin.death.create', 'uses' => 'DeathCertificateController@create']);
        Route::post('death/store', ['as' => 'admin.death.store',            'uses' => 'DeathCertificateController@store']);
        Route::get('death/{Id}/edit', ['as' => 'admin.death.edit',             'uses' => 'DeathCertificateController@edit']);
        Route::post('death/{Id}', ['as' => 'admin.death.update',             'uses' => 'DeathCertificateController@update']);
        Route::get('death/{id}/confirm-delete', ['as' => 'admin.death.confirm-delete',   'uses' => 'DeathCertificateController@getModalDelete']);

        //Migration Registration
        Route::get('migration', ['as' => 'admin.migration.index', 'uses' => 'MigrationRegistrationController@index']);
        Route::get('migration/create', ['as' => 'admin.migration.create', 'uses' => 'MigrationRegistrationController@create']);
        Route::post('migration/store', ['as' => 'admin.migration.store',            'uses' => 'MigrationRegistrationController@store']);
        Route::get('migration/{Id}/edit', ['as' => 'admin.migration.edit',             'uses' => 'MigrationRegistrationController@edit']);
        Route::post('migration/{Id}', ['as' => 'admin.migration.update',             'uses' => 'MigrationRegistrationController@update']);
        Route::get('migration/{id}/confirm-delete', ['as' => 'admin.migration.confirm-delete',   'uses' => 'MigrationRegistrationController@getModalDelete']);

        Route::get('getStockUnit', ['as' => 'admin.getStockUnit',            'uses' => 'LocaltaxController@getStockUnit']);
        ...
        Route::get('payment-report', ['as' => 'admin.accounts.paymentreports.', 'uses' => 'AccountReportController@paymentReport']);
     ...
     //BiometricController
        ...
        Route::get('archive/tasks/{id}/', ['as' => 'admin.archive.tasks',          'uses' => 'ProjectTaskController@archiveTasks']);

        //tasks modal
        Route::get('project_tasks/create/modals/{projectid}', ['as' => 'admin.project_task.modals',           'uses' => 'ProjectTaskController@openmodal']);
        Route::get('project_tasks/create/task-global-modal', ['as' => 'admin.project_task.globalModal',           'uses' => 'ProjectTaskController@globalmodal']);
        ...
        Route::get('/report-center', ['as' => 'admin.repscenter.index', 'uses' => 'ReportsController@index']);
        ...
        Route::get('mail/showsent/{mailid}', ['as' => 'admin.mail.showsent',   'uses' => 'MailController@showSent']);
        ...
        Route::post('mail/group_email_clients', ['as' => 'admin.mail.group_email_clients',           'uses' => 'MailController@group_email_clients']);
        Route::post('mail/client_email_contacts', ['as' => 'admin.mail.client_email_contacts',           'uses' => 'MailController@client_email_contacts']);
        ...
        Route::get('products/downloadExcel/{type}', ['as' => 'admin.products.importexport.export', 'uses' => 'ExcelController@exportProducts']);
        ...
        Route::post('add_earned_leave/{id}/edit',['as'=>'admin.add_earned_leave_upd.edit',
        ...
        Route::get('allpendingprofilerequest', ['as' => 'admin.allpendingprofilerequest', 'uses' => 'UserDetailController@allpendingprofilerequest']);

        Route::get('timechange_request', ['as' => 'admin.timechange_request',   'uses' => 'ShiftAttendanceController@timeChangeRequest']);

        Route::post('attendance_request_proxy/create', ['as' => 'admin.attendance_request_proxy.create',   'uses' => 'ShiftAttendanceController@attendanceRequestProxy']);
        Route::get('attendance_request_proxy_modal/{clock_history_id}', ['as' => 'admin.attendance_request_proxy_modal',   'uses' => 'ShiftAttendanceController@attendanceProxyModal']);
        Route::post('attendance_request_proxy/update/{clock_history_id}', ['as' => 'admin.attendance_request_proxy.update',   'uses' => 'ShiftAttendanceController@updateAttendanceProxy']);
        Route::get('attendance_request_proxy/forward/{clock_history_id}', ['as' => 'admin.attendance_request_proxy.forward',   'uses' => 'ShiftAttendanceController@forwardAttendanceProxy']);
        ...
        Route::get('travel_request_modal/{id}', ['as' => 'admin.travel_request_modal.view', 'uses' => 'TarvelRequestController@requestViewModal']);
        Route::post('travel_request_modal/edit/{id}', ['as' => 'admin.travel_approve.update', 'uses' => 'TarvelRequestController@requestApproveModal']);
        Route::get('travel_request/forward/{id}', ['as' => 'admin.travel_approve.forward', 'uses' => 'TarvelRequestController@requestforward']);
        ...
        Route::get('payroll/remote_taxable_categories', ['as' => 'admin.payroll.remote_taxable_categories',   'uses' => 'PaymentController@remote_taxable_categories']);
        Route::get('payroll/remote_taxable_categories_create', ['as' => 'admin.payroll.remote_taxable_categories.create',   'uses' => 'PaymentController@remote_taxable_categories_create']);
        Route::get('payroll/remote_taxable_categories_edit/{id}', ['as' => 'admin.payroll.remote_taxable_categories.edit',   'uses' => 'PaymentController@remote_taxable_categories_edit']);


        Route::post('payroll/remote_taxable_categories_store', ['as' => 'admin.payroll.remote_taxable_categories.store',   'uses' => 'PaymentController@remote_taxable_categories_store']);

        Route::post('payroll/remote_taxable_categories_update/{id}', ['as' => 'admin.payroll.remote_taxable_categories.update',   'uses' => 'PaymentController@remote_taxable_categories_update']);
        Route::get('payroll/confirm-delete{id}', ['as' => 'admin.remote_taxable_categories.confirm-delete', 'uses' => 'PaymentController@getModalDelete']);

                        // new payroll system
        Route::get('get-departments/{id}', ['as' => 'admin.payrolllist.getDepartments',   'uses' => 'PayrollControllerNew@getDepartments']);
        ...
        Route::get('payroll/edit/{id}', ['as' => 'admin.payrolllist.edit',   'uses' => 'PayrollControllerNew@edit']);
        Route::post('payroll/update/{id}', ['as' => 'admin.payrolllist.update',   'uses' => 'PayrollControllerNew@update']);

        Route::get('/payroll/download-payroll', ['as' => 'admin.payrolllist.download',   'uses' => 'PayrollControllerNew@payrollDownload']);

        Route::get('/payroll/download-payroll-individual', ['as' => 'admin.payrolllist.downloadpayrollindividual',   'uses' => 'PayrollControllerNew@downloadpayrollindividual']);
        Route::get('/payroll/generate-pdf', ['as' => 'admin.payrolllist.generatePdf',   'uses' => 'PayrollControllerNew@generatePdf']);

        Route::get('payroll-list/{id}/confirm-delete', ['as' => 'admin.payroll.confirm-delete',   'uses' => 'PayrollControllerNew@getModalDelete']);
        Route::get('payroll-list/{id}/delete', ['as' => 'admin.payroll.delete',           'uses' => 'PayrollControllerNew@destroy']);
        ...
        Route::get('download/customer/pdf/index', ['as' => 'admin.download.customer.pdf.index', 'uses' => 'DownloadIndexController@customerpdf']);
        Route::get('download/products/pdf/index', ['as' => 'admin.download.products.pdf.index', 'uses' => 'DownloadIndexController@productspdf']);

        //supplier import
        Route::get('supplier/importExport', ['as' => 'admin.import-export-supplier.index',            'uses' => 'ExcelController@indexSupplier']);
        Route::post('supplier/importExcelClients', ['as' => 'admin.import-export-supplier.store', 'uses' => 'ExcelController@importExcelSupplier']);
        Route::get('downloadExcelsupplier/{type}', ['as' => 'admin.downloadExcelsupplier', 'uses' => 'ExcelController@downloadExcelsupplier']);
        Route::get('download/supplier/pdf/index', ['as' => 'admin.download.supplier.pdf.index', 'uses' => 'DownloadIndexController@supplierpdf']);
        ...
        // For Project Task
        Route::get('project_tasks', ['as' => 'admin.project_task.index',           'uses' => 'ProjectTaskController@index']);
        Route::post('task/attachment/upload', ['as' => 'admin.project_task.attachment.upload', 'uses' => 'ProjectTaskController@attachmentUpload']);
        Route::get('task/attachment/delete/{id}', ['as' => 'admin.project_task.attachment.delete','uses' => 'ProjectTaskController@deleteAttachment']);
        // For Project Task
        ...
        Route::get('post_comment/delete/{id}', ['as' => 'admin.post_comment.delete','uses' => 'ProjectTaskController@deleteComment']);
        ...
        Route::get('chartofaccounts/{id}/groups/delete', ['as' => 'admin.chartofaccounts.groups.delete',           'uses' => 'COAController@destroyGroups']);
        ...
        Route::get('chartofaccounts/print/{id}', ['as' => 'admin.chartofaccountsnt.print', 'uses' => 'COAController@PrintLedgers']);
        ...
        Route::post('ExcelentriesAdd/', ['as' => 'admin.Excelentries.store', 'uses' => 'EntryController@importentries']);


        //reconciliations
        Route::get('reconciliations', ['as' => 'admin.reconciliations', 'uses' => 'ReconciliationController@index']);
        Route::get('reconciliationdetail', ['as' => 'admin.reconciliations.details', 'uses' => 'ReconciliationController@reconciliationdetail']);
        Route::put('reconcile_Update', ['as' => 'admin.reconcile_update', 'uses' => 'ReconciliationController@update']);


        Route::get('reconcile/pdf/{id}', ['as' => 'admin.reconcile.pdf', 'uses' => 'ReconciliationController@DownloadPdf']);
        Route::get('reconcile/print/{id}', ['as' => 'admin.reconcile.print', 'uses' => 'ReconciliationController@PrintLedgers']);
        Route::get('reconcile/excel/{id}', ['as' => 'admin.reconcile.excel', 'uses' => 'ReconciliationController@downloadExcel']);
        ...
        Route::get('chartofaccounts/pdf/', ['as' => 'admin.chartofaccountsdnl.pdf', 'uses' => 'COAController@DownloadPdf']);
        ...
        Route::get('late_arrival',['as'=>'admin.late_arrival.report','uses'=>'ShiftAttendanceReportController@lateArrivalReport']);
        Route::post('late_arrival',['as'=>'admin.late_arrivalpst.report','uses'=>'ShiftAttendanceReportController@lateArrivalReportView']);
        ...
        Route::post('expenses/postCreateModal', ['as' => 'admin.expenses.postCreateModal',             'uses' => 'ExpensesController@postCreateModal']);

//        Route::get('getPurchaseBillInfo', ['as' => 'admin.getPurchaseBillInfo', 'uses' => 'SupplierReturnController@getPurchaseBillInfo']);
        Route::get('getPurchaseBillInfo', ['as' => 'admin.getPurchaseBillInfo', 'uses' => 'GrnController@getPurchaseBillInfo']);
...
//        Route::get('migrate-data/{table}',['as'=>'admin.migrateData','uses'=>'FiscalyearController@migrateData']);
        ...
        //digital profiling routes
        Route::get('household/{id}/member-details/create', ['as' => 'household.member-details.create', 'uses' => 'HouseholdFamilyMemberDetailsController@create']);
        Route::post('household/member-details', ['as' => 'household.member-details.store', 'uses' => 'HouseholdFamilyMemberDetailsController@store']);
        Route::get('household/{householdId}/member-details/{id}/edit', ['as' => 'household.member-details.edit', 'uses' => 'HouseholdFamilyMemberDetailsController@edit']);
        Route::get('household/{householdId}/member-details/{id}', ['as' => 'household.member-details.show', 'uses' => 'HouseholdFamilyMemberDetailsController@show']);
        Route::patch('household/member-details/{id}', ['as' => 'household.member-details.update', 'uses' => 'HouseholdFamilyMemberDetailsController@update']);
        Route::get('household/member-details/destroy/{id}', ['as' => 'household.member-details.destroy', 'uses' => 'HouseholdFamilyMemberDetailsController@destroy']);
        
        Route::get('household/{id}/quadrupeds/create', ['as' => 'household.quadrupeds.create', 'uses' => 'HouseholdQuadrupedsAndLivestocksDetailController@create']);
        Route::post('household/quadrupeds', ['as' => 'household.quadrupeds.store', 'uses' => 'HouseholdQuadrupedsAndLivestocksDetailController@store']);
        Route::get('household/{householdId}/quadrupeds/{id}/edit', ['as' => 'household.quadrupeds.edit', 'uses' => 'HouseholdQuadrupedsAndLivestocksDetailController@edit']);
        Route::get('household/{householdId}/quadrupeds/{id}', ['as' => 'household.quadrupeds.show', 'uses' => 'HouseholdQuadrupedsAndLivestocksDetailController@show']);
        Route::patch('household/quadrupeds/{id}', ['as' => 'household.quadrupeds.update', 'uses' => 'HouseholdQuadrupedsAndLivestocksDetailController@update']);
        Route::get('household/quadrupeds/destroy/{id}', ['as' => 'household.quadrupeds.destroy', 'uses' => 'HouseholdQuadrupedsAndLivestocksDetailController@destroy']);

        Route::get('household/{id}/field/create', ['as' => 'household.field.create', 'uses' => 'HouseholdFieldController@create']);
        Route::post('household/field', ['as' => 'household.field.store', 'uses' => 'HouseholdFieldController@store']);
        Route::get('household/{householdId}/field/{id}/edit', ['as' => 'household.field.edit', 'uses' => 'HouseholdFieldController@edit']);
        Route::get('household/{householdId}/field/{id}', ['as' => 'household.field.show', 'uses' => 'HouseholdFieldController@show']);
        Route::patch('household/field/{id}', ['as' => 'household.field.update', 'uses' => 'HouseholdFieldController@update']);
        Route::get('household/field/destroy/{id}', ['as' => 'household.field.destroy', 'uses' => 'HouseholdFieldController@destroy']);

        Route::get('household/destroy/{id}', 'HouseholdController@destroy')->name('household.destroy');
        Route::resource('household', 'HouseholdController');

//new route-pms
       //plan/program registration
        Route::get('plan', ['as' => 'plan', 'uses' => 'PlanRegisterController@index']);
        Route::get('plan/create', ['as' => 'plan.create', 'uses' => 'PlanRegisterController@create']);
        Route::post('plan/store', ['as' => 'plan.store', 'uses' => 'PlanRegisterController@store']); 
        Route::get('plan/edit/{id}', ['as' => 'plan.edit', 'uses' => 'PlanRegisterController@edit']);
        Route::post('plan/update/{id}', ['as' => 'plan.update', 'uses' => 'PlanRegisterController@update']);
        Route::get('plan/delete/{id}', ['as' => 'plan.delete', 'uses' => 'PlanRegisterController@delete']);
        Route::get('plan/next/{id}', ['as' => 'plan.next', 'uses' => 'PlanRegisterController@multitaboption']);
        
        //costestimate
        Route::post('costestimate/store', ['as' => 'costestimate.store', 'uses' => 'CostEstimateController@store']);
        Route::post('costestimate/update/{id}', ['as' => 'costestimate.update', 'uses' => 'CostEstimateController@update']);
        
        //planagreement
        Route::post('planagreement/store', ['as' => 'planagreement.store', 'uses' => 'PlanAgreementController@store']);
        Route::post('planagreement/update/{id}', ['as' => 'planagreement.update', 'uses' => 'PlanAgreementController@update']);

        //printoption(niraj)
        Route::get("print/option/one/{id}", ['as' => 'admin.plan.option.one', 'uses' => 'PrintController@printone']);
        
        Route::get("print/option/two/{id}", ['as' => 'admin.plan.option.two', 'uses' => 'PrintController@printtwo']);
       
        Route::get("print/option/three/{id}", ['as' => 'admin.plan.option.three', 'uses' => 'PrintController@printthree']);

        Route::get("print/option/four/{id}", ['as' => 'admin.plan.option.four', 'uses' => 'PrintController@printfour']);

        Route::get("print/option/five/{id}", ['as' => 'admin.plan.option.five', 'uses' => 'PrintController@printfive']);
        Route::get("print/option/six/{id}", ['as' => 'admin.plan.option.six', 'uses' => 'PrintController@printsix']);

        //new route files-samjhauta files
        Route::get('pms/agreed', ['as' => 'pmsagreed.index', 'uses' => 'PmsAgreedController@index']);
        Route::get('pms/agreed/{id}/edit', ['as' => 'pmsagreed.edit', 'uses' => 'PmsAgreedController@edit']);
        Route::patch('pms/agreed/photo/{id}', ['as' => 'pmsagreed.photo.update', 'uses' => 'PmsAgreedController@updatePhoto']);
        Route::patch('pms/agreed/extension/{id}', ['as' => 'pmsagreed.extension.update', 'uses' => 'PmsAgreedController@updateExtension']);
        Route::post('pms/financial/transaction', [ 'as' => 'pms.financial.transaction', 'uses' => 'PmsAgreedController@financial_transaction']);
       
        //completion program
        Route::get('pms/current/complete', ['as' => 'pms.current.complete', 'uses'=> 'PmsAgreedController@current_year_index']);
        Route::get('pms/current/{id}/edit', ['as' => 'pms.current.edit', 'uses' => 'PmsAgreedController@currentedit']);
        Route::get('pms/previous/complete', ['as' => 'pms.current.edit', 'uses' => 'PmsAgreedController@previous_year_index']);

        //Plan Money Transfer
        Route::get('plantransfer', ['as' => 'plantransfer', 'uses' => 'PlanTransferController@index']);
        Route::get('plantransfer/create', ['as' => 'plantransfer.create', 'uses' => 'PlanTransferController@create']);
        Route::post('plantransfer/store', ['as' => 'plantransfer.store', 'uses' => 'PlanTransferController@store']); 
        Route::get('plantransfer/edit/{id}', ['as' => 'plantransfer.edit', 'uses' => 'PlanTransferController@edit']);
        Route::post('plantransfer/update/{id}', ['as' => 'plantransfer.update', 'uses' => 'PlanTransferController@update']);
        Route::get('plantransfer/delete/{id}', ['as' => 'plantransfer.delete', 'uses' => 'PlanTransferController@delete']);

        //expenditure
        Route::get('expenditure', ['as' => 'expenditure', 'uses' => 'ExpenditureController@index']);
        Route::get('expenditure/create', ['as' => 'expenditure.create', 'uses' => 'ExpenditureController@create']);
        Route::post('expenditure/store', ['as' => 'expenditure.store', 'uses' => 'ExpenditureController@store']); 
        Route::get('expenditure/edit/{id}', ['as' => 'expenditure.edit', 'uses' => 'ExpenditureController@edit']);
        Route::post('expenditure/update/{id}', ['as' => 'expenditure.update', 'uses' => 'ExpenditureController@update']);
        Route::get('expenditure/delete/{id}', ['as' => 'expenditure.delete', 'uses' => 'ExpenditureController@delete']);

        //program
        Route::get('program', ['as' => 'program', 'uses' => 'ProgramController@index']);
        Route::get('program/create', ['as' => 'program.create', 'uses' => 'ProgramController@create']);
        Route::post('program/store', ['as' => 'program.store', 'uses' => 'ProgramController@store']); 
        Route::get('program/edit/{id}', ['as' => 'program.edit', 'uses' => 'ProgramController@edit']);
        Route::post('program/update/{id}', ['as' => 'program.update', 'uses' => 'ProgramController@update']);
        ...
        Route::get('area/edit/{id}', ['as' => 'admin.area.edit', 'uses' => 'AreaController@edit']);
        Route::post('area/update/{id}', ['as' => 'area.update', 'uses' => 'AreaController@update']);
        Route::get('area/delete/{id}', ['as' => 'area.delete', 'uses' => 'AreaController@delete']);
            
        //subarea
        Route::get('subarea', ['as' => 'subarea', 'uses' => 'SubAreaController@index']);
        Route::get('subarea/create', ['as' => 'subarea.create', 'uses' => 'SubAreaController@create']);
        Route::post('subarea/store', ['as' => 'subarea.store', 'uses' => 'SubAreaController@store']);
        Route::get('subarea/edit/{id}', ['as' => 'subarea.edit', 'uses' => 'SubAreaController@edit']);
        Route::post('subarea/update/{id}', ['as' => 'subarea.update', 'uses' => 'SubAreaController@update']);
        Route::get('subarea/delete/{id}', ['as' => 'subarea.delete', 'uses' => 'SubAreaController@delete']);

        //program/activities
        Route::get('activitiesmgmt', ['as' => 'activitiesmgmt', 'uses' => 'ActivitiesMgmtController@index']);
        Route::get('activitiesmgmt/create', ['as' => 'activitiesmgmt.create', 'uses' => 'ActivitiesMgmtController@create']);
        Route::post('activitiesmgmt/store', ['as' => 'activitiesmgmt.store', 'uses' => 'ActivitiesMgmtController@store']);
        Route::get('activitiesmgmt/edit/{id}', ['as' => 'activitiesmgmt.edit', 'uses' => 'ActivitiesMgmtController@edit']);
        Route::post('activitiesmgmt/update/{id}', ['as' => 'activitiesmgmt.update', 'uses' => 'ActivitiesMgmtController@update']);
        Route::get('activitesmgmt/delete/{id}', ['as' => 'activitiesmgmt.delete', 'uses' => 'ActivitiesMgmtController@delete']);

        //grant
        Route::get('grantmgmt', ['as' => 'grantmgmt', 'uses' => 'GrantController@index']);
        Route::get('grantmgmt/create', ['as' => 'grantmgmt.create', 'uses' => 'GrantController@create']);
        Route::post('grant/store', ['as' => 'grant.store', 'uses' => 'GrantController@store']);
        Route::get('grant/edit/{id}', ['as' => 'grant.edit', 'uses' => 'GrantController@edit']);
        Route::post('grant/update/{id}', ['as' => 'grant.update', 'uses' => 'GrantController@update']);
        Route::get('grant/delete/{id}', ['as' => 'grant.delete', 'uses' => 'GrantController@delete']);

        //appropriation
        Route::get('appropriation', ['as' => 'appropriation', 'uses' => 'AppropriationController@index']);
        Route::get('appropriation/create', ['as' => 'appropriation.create', 'uses' => 'AppropriationController@create']);
        Route::post('appropriation/store', ['as' => 'appropriation.store', 'uses' => 'AppropriationController@store']);
        Route::get('appropriation/edit/{id}', ['as' => 'appropriation.edit', 'uses' => 'AppropriationController@edit']);
        Route::post('appropriation/update/{id}', ['as' => 'appropriation.update', 'uses' => 'AppropriationController@update']);
        Route::get('appropriation/delete/{id}', ['as' => 'appropriation.delete', 'uses' => 'AppropriationController@delete']);
        ...
        Route::post('template/update/{id}', ['as' => 'template.update', 'uses' => 'TemplateController@update']);
        Route::get('template/delete/{id}', ['as' => 'template.delete', 'uses' => 'TemplateController@delete']);

        //unit
        Route::get('unit', ['as' => 'unit', 'uses' => 'PhysicalUnitController@index']);
        Route::get('unit/create', ['as' => 'unit.create', 'uses' => 'PhysicalUnitController@create']);
        Route::post('unit/store', ['as' => 'unit.store', 'uses' => 'PhysicalUnitController@store']);
        Route::get('unit/edit/{id}', ['as' => 'unit.edit', 'uses' => 'PhysicalUnitController@edit']);
        Route::post('unit/update/{id}', ['as' => 'unit.update', 'uses' => 'PhysicalUnitController@update']);
        Route::get('unit/delete/{id}', ['as' => 'unit.delete', 'uses' => 'PhysicalUnitController@delete']);
        ...
        Route::get('extra/create', ['as' => 'extra.create', 'uses' => 'ExtraController@create']);
        Route::post('extra/store', ['as' => 'extra.store', 'uses' => 'ExtraController@store']);
        Route::get('extra/edit/{id}', ['as' => 'extra.edit', 'uses' => 'ExtraController@edit']);
        Route::post('extra/update/{id}', ['as' => 'extra.update', 'uses' => 'ExtraController@update']);
        Route::get('extra/delete/{id}', ['as' => 'extra.delete', 'uses' => 'ExtraController@delete']);
        //end of setting

        //oraganizationmgmt
        Route::get('organizationmgmt', ['as' => 'organizationmgmt', 'uses' => 'OrganizationMgmtController@index']);
        Route::get('organizationmgmt/create', ['as' => 'organizationmgmt.create', 'uses' => 'OrganizationMgmtController@create']);
        Route::post('organizationmgmt/store', ['as' => 'organizationmgmt.store', 'uses' => 'OrganizationMgmtController@store']);
        Route::get('organizationmgmt/edit/{id}', ['as' => 'organizationmgmt.edit', 'uses' => 'OrganizationMgmtController@edit']);
        Route::post('organizationmgmt/update/{id}', ['as' => 'organizationmgmt.update', 'uses' => 'OrganizationMgmtController@update']);
        Route::get('organizationmgmt/delete/{id}', ['as' => 'organizationmgmt.delete', 'uses' => 'OrganizationMgmtController@delete']);

        //consumer
        Route::get('consumer', ['as' => 'consumer', 'uses' => 'ConsumerController@index']);
        Route::get('consumer/create', ['as' => 'consumer.create', 'uses' => 'ConsumerController@create']);
        Route::post('consumer/store', ['as' => 'consumer.store', 'uses' => 'ConsumerController@store']);
        Route::get('consumer/edit/{id}', ['as' => 'consumer.edit', 'uses' => 'ConsumerController@edit']);
        Route::post('consumer/update/{id}', ['as' => 'consumer.update', 'uses' => 'ConsumerController@update']);
        Route::get('consumer/delete/{id}', ['as' => 'consumer.delete', 'uses' => 'ConsumerController@delete']);

        //planprogramtaboption
