...
class UserDetailsProxy extends Model
{
    ...
    protected $fillable = [
        ...
        'join_date', 'date_of_probation', 'date_of_permanent', 'last_promotion_date', 'last_transfer_date', 'date_of_retirement', 'working_status', 'employemnt_type', 'job_title','ethnicity','date_of_birth','permanent_address','citizenship_num','resgination_date','user_detail_id'
    ];
