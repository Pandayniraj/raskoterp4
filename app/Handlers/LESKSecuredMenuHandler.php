...
class LESKSecuredMenuHandler implements MenuHandlerInterface
{
    ...
    public $MENU_HEADER = '';
    public $MENU_FOOTER = '';
    public $MENU_ITEM_SEPARATOR = "<li class='header'><span>@LABEL@</span></li>";
    public $MENU_ITEM_INACTIVE = "<li><a href='@URL@'><i class='material-icons'>@ICON@</i>&nbsp;<span>@LABEL@</span></a></li>";
    public $MENU_ITEM_ACTIVE = "<li class='active'><a href='@URL@'><i class='material-icons'>@ICON@</i>&nbsp;<span>@LABEL@</span><span class='sr-only'>(current)</span></a></li>";
    public $MENU_GROUP_START = "<li class='treeview'><a href='@URL@'><i class='material-icons'>@ICON@</i><span>@LABEL@</span><i class='fa fa-angle-left pull-right'></i></a><ul class='treeview-menu'>";
    public $MENU_GROUP_START_OPENED = "<li class='treeview active'><a href='@URL@'><i class='material-icons'>@ICON@</i><span>@LABEL@</span><i class='fa fa-angle-down pull-right'></i></a><ul class='treeview-menu menu-open'>";
    public $MENU_GROUP_START_CLOSED = "<li class='treeview'><a href='@URL@'><i class='material-icons'>@ICON@</i><span>@LABEL@</span><i class='fa fa-angle-left pull-right'></i></a><ul class='treeview-menu'>";
    ...
    public $TRAIL_ITEM_ACTIVE_NO_URL = "<li class='active'><i class='material-icons'>@ICON@</i>&nbsp;@LABEL@</li>";
    public $TRAIL_ITEM_ACTIVE_WITH_URL = "<li class='active'><a href='@URL@'><i class='material-icons'>@ICON@</i>&nbsp;@LABEL@</a></li>";
    public $TRAIL_ITEM_INACTIVE_NO_URL = "<li><i class='material-icons'>@ICON@</i>&nbsp;@LABEL@</li>";
    public $TRAIL_ITEM_INACTIVE_WITH_URL = "<li><a href='@URL@'><i class='material-icons'>@ICON@</i>&nbsp;@LABEL@</a></li>";
    ...
    public function getLeafMenuItem($leaf = null)
    {
        ...
        if ($routeLesk instanceof Route) {
            $leaf = $this->menuRepository->where('route_id', $routeLesk->id)->first();
