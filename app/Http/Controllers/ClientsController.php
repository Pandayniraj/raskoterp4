...
class ClientsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.clients.create', compact('client', 'perms', 'page_title', 'page_description','groups'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.clients.edit', compact('client', 'page_title', 'page_description', 'ledger_list', 'groups'));
    }
