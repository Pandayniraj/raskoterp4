...
class InvoiceController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.invoice.create', compact('page_title', 'users', 'page_description', 'order', 'units', 'orderDetail', 'products', 'clients', 'productlocation','outlets'));
    }
    ...
    public function returnfromird()
    {
        ...
        return view('admin.invoice.invoicereturn', compact('credit_note_no', 'page_title', 'fiscalyear','description','outlet'));
    }
