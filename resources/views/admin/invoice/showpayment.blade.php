...
<!-- 
                        ...
                        <div class="col-md-6">
                          <div class="form-group">  
                           <label class="control-label col-sm-3">Paid by</label>
                            <div class="input-group ">
                                <input type="text" name="amount" placeholder="Amount" id="price_value" value="{{$edit->paidby->name}}" class="form-control" required="required" readonly="">
                                <div class="input-group-addon">
                                    <a href="#"><i class="fa fa-credit-card"></i></a>
                                </div>
                            </div>
