   ...
   <div class='row'>
        <div class='col-md-12'> 
            <div class="box box-header">
                ...
                <div class="col-md-12">
                    <div class="">
                        <form method="POST" action="/admin/location/stocktransfer">
                            {{ csrf_field() }}
                           ...
                           <div class="col-md-12">
                                ...
                                <div class="col-md-3 form-group" style="">
                                    ...
                                    {!! Form::select('source_id',  $locations, null, ['class' => 'form-control input-sm', 'id'=>'source_id']) !!}
                                </div>
                                ...
                                <div class="col-md-3 form-group" style="">
                                    <label for="comment">Trasnsfer Date </label>
                                      <input type="text" class="form-control input-sm pull-right datepicker" name="transfer_date" value="{{\Carbon\Carbon::now()->toDateString()}}" id="bill_date">
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-3 form-group" style="">
                                    <label for="comment">Destination </label>
                                     {!! Form::select('destination_id',  $locations, null, ['class' => 'form-control input-sm', 'id'=>'destination_id']) !!}
                                </div>
                            </div>
