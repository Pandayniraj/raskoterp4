                    ...
                    <table class="table">
                        <tbody id="more-tr">
                            <tr>
                                ...
                                <td>
                                    <input type="number" class="form-control quantity" name="quantity[]" placeholder="Quantity"  value="1" required="required" step ='any'>
                                </td>
                                 <td>
                    ...
                    <table class="table">
                        <tbody id="more-custom-tr">
                            <tr>
                                ...
                                <td>
                                    <input type="number" class="form-control quantity" name="custom_items_qty[]" placeholder="Quantity"  value="1" required="required" step ='any'>
                                </td>
                                <td>
                             ...
                             <div class="row">
                                ...
                                <div class="col-md-12">
                                     ...
                                     <div class="col-md-3">
                                        ...
                                        <select name="purchase_bill_no" id="purchase_bill_no" required="" class="form-control pull-right ">
                                          <option value="">Select Supplier</option>
                                          @foreach($purchasebills as $key=>$value)
                                          <option value="{{ $value->id }}">
                                            {{ $value->client->name ?? ''}} ({{ $value->bill_no }})</option>
                                          @endforeach
                                        </select>
                                     ...
                                     <div class="col-md-3">
                                        <label>Return Date:</label>
                                          <input type="text" class="form-control pull-right datepicker date-toggle-nep-eng1" name="return_date" value="{{\Carbon\Carbon::now()->toDateString()}}" id="return_date" required="" readonly>
                                     </div>

                                     <div class="col-md-3">
                                        <label>Purchase Order Date:</label>
                                        <input type="text" class="form-control pull-right datepicker date-toggle-nep-eng1" name="purchase_order_date" value="" id="purchase_order_date" readonly>
                                     </div>
