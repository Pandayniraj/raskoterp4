...
<section class="content-header" style="margin-top: -35px; margin-bottom: 20px">
            <h1>
                {{ ucfirst(Request::segment(4)) }} Entry
            ...
            <div class="box-body">
				...
				<div class="">
								...
								<table class="table table-striped table-hover table-bordered">
								    ...
								    @if (isset($curEntryitems) && !empty($curEntryitems) && sizeof($curEntryitems, 1) > 5 ) 
								     ...
								     <!--  <tr>
                                      ...
                                      @else
									  <tr class="empty">
									    <td colspan="7" style="text-align:center">Data Loading ...</td>
									  </tr>
									  @endif
									  </tbody>
									<tbody>
					...
					<div class="form-group">
						...
						<textarea name="notes" class="form-control input-sm" tabindex="9" rows="2"></textarea>
					</div>
					<div class="form-group">
