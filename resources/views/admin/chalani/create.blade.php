            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="date" class="form-control input-sm datepicker date-toggle-nep-eng1" placeholder="मिति..." required="">
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="letter_num" class="form-control  input-sm" placeholder="पत्र नम्बर...">
                      <div class="input-group-addon">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 form-group">
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                         <input type="text" name="receiver_org" class="form-control  input-sm" placeholder="प्राप्तकर्ता संगठन..." >
                      <div class="input-group-addon">
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                        {!! Form::select('ticket_id',$tickets,null,['class'=>'form-control searchable','placeholder'=>'टिकट']) !!}
                      <div class="input-group-addon">
