                ...
                <table class="table table-hover table-bordered">
                    ...
                    @foreach($entry_items as $ei)
                        ...
                        <tr>
                            ...
                            <td>{{$getledger}} \ {{  $getEntryType['type']}} No. [{{ $getEntryType['order']->bill_no }}]
                            ...
                            <td>
                                <a href="/admin/entries/show/{{$ei->dynamicEntry()->entrytype->label}}/{{$ei->entry_id}}?fiscal_year={{\Session::get('selected_fiscal_year')}}" class="no-hover" escape="false" title='View'><i class="glyphicon glyphicon-log-in"></i></a>
