                                ...
                                @foreach($payroll->payrollDetails as $sk => $sv)
                                    <tr>
                                       ...
                                       <td  data-toggle="tooltip"><input type="number" title = "{{ $sv->user->first_name.' '.$sv->user->last_name }} |  Paid Leave Days" data-toggle="tooltip" name="paid_leaves[]" class="form-control" value="{{$sv->paid_leaves}}" readonly></td>
                                        ...
                                        @endforeach
                                        <td  data-toggle="tooltip"><input type="number" title = "{{ $sv->user->first_name.' '.$sv->user->last_name }} | Incentive" data-toggle="tooltip" name="incentive[]" class="form-control incentive" value="{{$sv->incentive}}" readonly></td>
                                        ...
                                        <td  data-toggle="tooltip"><input type="number" title = "{{ $sv->user->first_name.' '.$sv->user->last_name }} | Gratuity" data-toggle="tooltip" name="gratuity[]" class="form-control gratuity" value="{{$sv->gratuity}}" readonly></td>
                                        ...
                                        <td  data-toggle="tooltip"><input type="number" title = "{{ $sv->user->first_name.' '.$sv->user->last_name }} | Insurance Premium" data-toggle="tooltip" name="insurance_premium[]" class="form-control insurance_premium" value="{{$sv->insurance_premium}}" readonly></td>
                                        ...
                                        <td  data-toggle="tooltip"><input type="number" title = "{{ $sv->user->first_name.' '.$sv->user->last_name }} | Dormitory" data-toggle="tooltip" name="dormitory[]" class="form-control dormitory" value="{{$sv->dormitory}}" readonly></td>
                                        <td  data-toggle="tooltip"><input type="number" title = "{{ $sv->user->first_name.' '.$sv->user->last_name }} | Meal" data-toggle="tooltip" name="meal[]" class="form-control meal" value="{{$sv->meal}}" readonly></td>
