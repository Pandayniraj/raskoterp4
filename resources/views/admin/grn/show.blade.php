          ...
          <h2 class="page-header">
            ...
            <span class="pull-right">
              <span>Good Receipt Note</span>
               <a href="/admin/grn/print/{{ $ord->id }}" target="_blank" class="btn btn-default btn-sm"><i class="fa fa-print"></i> Print</a>
...
{{--              </tr>--}}
              ...
              <tr style="padding:0px; margin:0px;">
                ...
                <tr>
                    <th style="width:50%">Tax Free Amount</th> <td>{{env('APP_CURRENCY').' '. number_format($ord->non_taxable_amount,2) }}</td>
                </tr>
               <tr style="padding:0px; margin:0px;">
