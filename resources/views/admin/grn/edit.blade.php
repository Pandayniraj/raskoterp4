        ...
        <div class='col-md-12'>
            <div class="box-body">
                ...
                <div class="col-md-12">
                        ...
                        <form method="POST" action="/admin/grn/{{$purchasereturn->id}}">
                            {{ csrf_field() }}
                                ...
                                <div class="col-md-12">
                                     ...
                                     <div class="col-md-3">
                                        <label>Purchase bill No</label>
                                          <input type="text" class="form-control pull-right " name="purchase_bill_no" value="{{sprintf('%08d',$purchasereturn->purchase_bill_no)}}" id="purchase_bill_no" required="" readonly>
                                     </div>

                                      <div class="col-md-3">
                                        <label>Supplier Name:</label>
                                          <input type="text" class="form-control pull-right " name="client_name" value="{{$purchasereturn->supplier->name}}" id="customer_name" readonly>
                                     ...
                                     <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control pull-right datepicker" name="purchase_order_date" value="{{$purchasereturn->purchase_order_date}}" id="purchase_order_date" readonly>
                                     </div>
                                  ...
                                  <div class="col-md-12" style="margin-left: 15px">
                                      ...
                                      <div class="col-md-3">
                                          <div class="form-group">
                                              ...
                                              {!! Form::select('department_id', [''=>'Select']+$departments, $purchasereturn->department_id, ['class' => 'form-control label-default','id'=>'department_id']) !!}
                                          </div>
                                          <!-- /.input group -->
                                      </div>
                                      <div class="col-md-3">
...
{{--                                          <div class="form-group">--}}
{{--                                              <label>Store:</label>--}}
{{--                                              {!! Form::select('store_id', [''=>'Select']+$stores, $purchasereturn->store_id, ['class' => 'form-control label-default','id'=>'store_id']) !!}--}}
{{--                                          </div>--}}
{{--                                          <!-- /.input group -->--}}
{{--                                      </div>--}}
                                  </div>
...
<hr/>
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                          <td>
                                          <input type="text" class="form-control input-sm product_id" name="product"  value="{{$odv->product->name}}" readonly>
                                            <input type="hidden"  name="product_id[]" value="{{$odv->product_id}}" required="required" readonly>
                                          </td>
                                          <td>
                                              <input type="text" class="form-control input-sm invoice_price" placeholder="Unit" value="{{$odv->unitname->name}}" required="required" readonly>
                                              <input  type="hidden" name="units[]" value="{{$odv->units}}">

                                          </td>
                                          <td>
                                              <input type="text" class="form-control input-sm purchase_quantity" name="purchase_quantity[]" placeholder="Quantity" min="1" value="{{$odv->purchase_quantity}}" required="required" readonly>
                                          </td>

                                          <td>
                                              <input type="text" class="form-control input-sm quantity" name="return_quantity[]" placeholder="Return Quantity" min="1" value="{{$odv->return_quantity}}" required="required" step="any">
                                          </td>

                                          <td>
                                             <input type="text" class="form-control input-sm purchase_price" name="purchase_price[]" placeholder="Purchase Price" min="1" value="{{$odv->purchase_price}}" required="required" readonly>
                                          </td>
                                          <td>
                                              <input type="text" class="form-control input-sm price" name="return_price[]" placeholder="Price" min="1" value="{{$odv->return_price}}" required="required" step="any">
                                          </td>
                                          <td>
                                              <input type="hidden" class="form-control input-sm discount_percent_line" name="discount_percent[]" placeholder="Discount Percent" step="any" value="{{$odv->discount_percent}}" required="required" >
                                              <input type="text" class="form-control input-sm discount_amount_line" name="discount_amount[]" placeholder="Discount Amount" step="any" value="{{$odv->discount_amount}}" required="required" readonly>
                                          </td>
                                          <td>

                                              <input  class="form-control input-sm col-md-1"
                                                      value="{{$odv->tax_rate}}%" readonly="readonly">
                                              <input type="hidden" class="form-control input-sm col-md-1 tax_rate" name="tax_rate[]"
                                                      value="{{$odv->tax_rate}}" >
                                              <input type="hidden" class="form-control tax_amount_line input-sm" name="tax_amount[]" placeholder="Tax Amount" min="1" value="{{$odv->tax_amount}}" step="any">

                                          </td>
                                           <td>
                                               <input type="text" class="form-control input-sm total" name="return_total[]" placeholder="Total" value="{{$odv->return_total}}" readonly="readonly">
                                          </td>

                                          <?php
                                          $product=\App\Models\Product::find($odv->product_id);
                                          $is_expirable=$product->is_expirable;
                                          ?>

                                          <td>
                                              <input type="text" class="form-control input-sm expiry datepicker" name="expiry[]" {{$is_expirable==0?'readonly':''}} placeholder="Expiry" value="{{$odv->expiry}}">

                                          </td>

                                          <td>
                                              <input type="text" class="form-control input-sm reason" name="reason[]" placeholder="Reason" value="{{$odv->reason}}">
                                          </td>
                                          <td>
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                              <input type="text" class="form-control input-sm expiry datepicker" name="expiry[]" readonly placeholder="Expiry" value="{{$odv->expiry}}">

                                          </td>
                                          <td>
                                              <input type="text" class="form-control reason" name="custom_reason[]" placeholder="Reason" value="{{$odv->reason}}">
                                          </td>
                                          <td>
                                              <a href="javascript::void(1);" >
                                                  <i class="remove-this btn btn-xs btn-danger icon fa fa-trash deletable" style="float: right; color: #fff;"></i>
...
{{--                                        </tr>--}}
                                        ...
                                        <tr>
                                            ...
                                            <td id="non-taxable-amount">{{$purchasereturn->non_taxable_amount}}</td>
                                            <td>&nbsp; <input type="hidden" name="non_taxable_amount" id="nontaxableamount" value="{{$purchasereturn->non_taxable_amount}}"></td>
                                        </tr>
                                        <tr>
...
function calcTotal() {
    ...
    $(".total").each(function(index) {
        if (isNumeric($(this).val())&&$(this).val()!=''){
            ...
            if(tax_rate==0)
                nontaxableAmount+=(amt_before_disc-discount)
            else
                taxableAmount+=(amt_before_disc-discount)
        }
    });
