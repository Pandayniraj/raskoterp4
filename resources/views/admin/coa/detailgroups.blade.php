							...
							<div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input id="ReportStartdate" type="text" name="startdate" class="form-control input-sm datepicker" value="{{$startdate??$fiscal->start_date}}">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input id="ReportEnddate" type="text" name="enddate" class="form-control input-sm datepicker" value="{{$enddate??$fiscal->end_date}}">
                                            <div class="input-group-addon">
                                                <i>
...
{{--                                </div>--}}
                ...
                <div style="text-align: center;"> {!! $entry_items->appends(\Request::except('page'))->render() !!} </div>
