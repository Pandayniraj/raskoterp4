...
$(document).ready(function() {
 ...
 function CategoryTree($parent_id=null,$sub_mark='',$selectedgroup_value){
    ...
    $groups= \App\Models\COAgroups::orderBy('code', 'asc')->when($parent_id,function ($q) use ($parent_id) {
							...
							<div class="col-md-12">
								<div class="form-group">
									<label>Parent Group</label>
										<select name="group_id" id="LedgerGroupId" class="form-control searchable-ledgers" aria-hidden="true">
