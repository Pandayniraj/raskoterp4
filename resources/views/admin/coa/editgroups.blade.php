                       ...
                       <div class="row">
	                      <div class="col-xs-5">
		                    <div class="form-group">
		                    	...
		                    	<select name="parent_id" class="form-control select2-hidden-accessible" id="GroupParentId" aria-hidden="true">
							...
							<div class="col-xs-2">
								<div class="form-group">
									...
									<input type="text" name="code" value="{{$group_data->code}}" class="form-control" id="g_code" readonly>
							    </div>
							</div>
							<div class="col-xs-5">
								<div class="form-group">
