  ...
  ?>
      ...
      <div id="details" class="clearfix">
        ...
        <div id="client">
          ...
          <div class="address">Notes: {{$ledgers_data->notes}}<br/></div>
          <div class="">Opening balance as on {{date('d-M-Y', strtotime($startOfYear))}}:@if($ledgers_data->op_balance_dc == 'D') Dr @else Cr @endif{{$ledgers_data->op_balance}}</div>
            <?php 
         ...
         <?php
          ...
          @foreach($entry_items as $ei)
           ...
           <?php 
            ...
            ?>
           <tr>
              <td style="white-space: nowrap;">{{$ei->entry->date}}<br>{{ TaskHelper::getNepaliDate($ei->entry->date) }}</td>
