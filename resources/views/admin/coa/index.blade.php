      ...
      foreach($groups as $group){
        ...
        if($group->id<=4){
           ...
           echo '<tr id="'.$group->id.'" class="group-class bg-purple">
                ...
                <td class="'.$class.'" onclick="{{if('.$group->children->count().'<1)'.'getLedgers(this,'.$group->id.')'.'}}"><b>
...
<span style="margin-left:10px;display:none;color:grey">No Ledgers Created for this group.</span>
    '.(($group->children->count()<1)?'<i class="fa fa-chevron-down"></i>':"").'
</td>
                <td><b>Group</b></td>
                <td>-</td>
                <td>-</td>
                <td>
                <a href="'.route('admin.chartofaccounts.detail.groups', $group->id).'" title="View Group Statement"><i class="fa fa-eye"></i></a>
           ...
           echo '<tr id="'.$group->id.'" class="group-class">
                ...
                <td class="'.$class.'" onclick="{{if('.$group->children->count().'<1)'.'getLedgers(this,'.$group->id.')'.'}}"><b>
                    <i class="fa fa-spinner fa-spin" style="display:none"></i>&nbsp;'.$group->name.'</b>
    <span style="margin-left:10px;display:none;color:grey">No Ledgers Created for this group.</span>
    '.(($group->children->count()<1)?'<i class="fa fa-chevron-down"></i>':"").'</td>
                <td><b>Group</b></td>
                <td>-</td>
                <td>-</td>
        ...
        <div class='col-md-12'>
            <!-- Box -->
             <div class="box-header with-border">
                        <a class="btn btn-default btn-sm" href="{!! route('admin.chartofaccounts.create.ledgers') !!}" title="Create CoaLedgers">
                            <i class="fa fa-plus"></i> Create New Ledger
                        </a>
                        &nbsp;
                        <a class="btn btn-default btn-sm" href="{!! route('admin.chartofaccounts.create.groups') !!}" title="Create CoaGroups">
                            <i class="fa fa-plus"></i> Create New Ledger Group
                        </a>
                        &nbsp;
                        <a class="btn btn-social btn-sm" href="{!! route('admin.ExcelLedgergroups.index') !!}" title="Import/Export CoaLedgers">
                            <i class="fa fa-download"></i>Import/Export Ledger Group
                        </a>
                        &nbsp;

                        <a class="btn btn-social btn-sm" href="{!! route('admin.ExcelLedger.index') !!}" title="Import/Export CoaLedgers">
                            <i class="fa fa-download"></i>Import/Export Ledger
                        </a>
                        &nbsp;


                        <a class="btn btn-social  btn-sm" href="{!! route('admin.filter.coa.groups.detail') !!}">
                            <i class="fa fa-bars"></i>Filter By Account Heads
                        </a>
                        &nbsp;
