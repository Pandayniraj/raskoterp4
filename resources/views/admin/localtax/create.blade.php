...
<div class='row'>
    <div class='col-md-12'>
        <div class="box box-header">
            ...
            <div class="col-md-12">
                <div class="">
                    <form method="POST" action="{{route('admin.localtax.store')}}">
                        {{ csrf_field() }}
                        ...
                        <div class="">
                           ...
                           <div class="col-md-12">
                            ...
                            <div class="col-md-3 form-group" style="">
                                ...
                                <input class="form-control input-sm " name="receipt_no" required type="text" placeholder="रसिद नं.">
                            </div>

                            <div class="col-md-3 form-group" style="">
                                <label for="user_id"> इलेक्ट्रोनिक लेनदेन नं.</label>
                                <input class="form-control input-sm " name="electronic_trans_no" required type="text" placeholder="इलेक्ट्रोनिक लेनदेन नं.">
                            </div>

                            <div class="col-md-3 form-group" style="">
                                <label for="user_id"> कार्यालयको कोड नं.</label>
                                <input class="form-control input-sm " name="officer_code_number" required type="text" placeholder="कार्यालयको कोड नं.">
                            </div>

                            <div class="col-md-3 form-group" style="">
                                <label for="user_id"> करदाताको नाम</label>
                                <input class="form-control input-sm " name="customer_name" required type="text" placeholder="करदाताको नाम">
                            </div>

                            <div class="col-md-3 form-group" style="">
                                <label for="user_id">मिति</label>
                                <input class="form-control input-sm datepicker date-toggle-nep-eng1" name="date" required type="text" placeholder="मिति">
                            </div>

                            <div class="col-md-3 form-group" style="">
                                <label for="user_id">प्रवेश क्लर्क</label>
                                <select required class="form-control input-sm" name="entered_by" required id="">
                                    <option selected disabled >व्यक्ति चयन गर्नुहोस्
                                    </option>
                        ...
                        <div class="col-md-12">
                            <a href="javascript:void(0)" class="btn btn-primary btn-xs" id="addCustomMore" style="float: right;margin-left:8px">
                                <i class="fa fa-plus"></i> <span>वस्तुहरू थप्नुहोस्</span>
                            </a>
                        </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="hidden" name="total_amount" class="total_amount" value="" required>
                        ...
                        <div class="box">
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <textarea rows="6" class="form-control TextBox comment" name="comment"></textarea>
                                </div>
                            </div>
                        </div>
