...
<section class="content-header" style="margin-top: -35px; margin-bottom: 20px">
          ...
          <i class="fa fa-info"></i> Create Dealers for Billing and Purchase.
            ...
            {!! Form::open( array('route' => 'admin.clients.enable-selected', 'id' => 'frmClientList') ) !!}
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <a class="btn btn-default btn-sm" href="{!! route('admin.clients.create') !!}?relation_type=dealer" title="{{ trans('admin/clients/general.button.create') }}">
