...
<body onload="window.print();" cz-shortcut-listen="true" class="skin-blue sidebar-mini">
    ...
    <div class='wrapper'>
            ...
            <div class="row" style="margin-top:15px">
                <p style="text-align: center;font-weight:600;">विषय  :- : बैंक खाता खोलिदिने सम्वन्धम । </p>
            </div>
            ...
            <div class="row" style="margin-left: 10px;margin-top:20px">
               <div class="col-md-12"> <p style="text-indent:3em;">   प्रस्तुत विषयमा यस रास्कोट नगरपालिका वडा नं स्थित <strong>{{ $plandetail->Name }}</strong> नाममा त्यस वैकमा तपसिल वमोजिमका
                पदाधिकारीहरुको संयुक्त हस्ताक्षर रहने गरी खाता संचालन गरिदिनु हुन सिफारिस साथ अनुरोध छ ।
                 </p></div>
            </div>    
            <div class="row" style="margin-top:20px; margin-left:5px;">
                ...
                <span>सम्झौता <strong>रू {{ $amount->appropriationamt ?? '' }}</strong></span><br>
                <span> सम्झौता मितिः <strong>{{ date('Y-m-d',strtotime($planagreement->agreementdate)) ?? '' }}</strong></span><br> 
            </div>
            <div class="row" style="margin-top:35px; margin-left:5px;">    
                ...
                <b style="text-align:center;">नि. प्रमुख प्रशासकीय अधिकृत</b>  <b style=" margin-left:105px;">याेजना शाख</b>
            </div>
    </div><!-- /.col -->
