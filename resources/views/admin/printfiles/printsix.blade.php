        ...
        @endphp
            <div class="row" style="margin-top: 10px;">
                <div class="col-xs-12 table-responsive">
                 <b>प.सं. : <strong>{{ $fiscalyear->fiscal_year }}<strong> </b> <span style="padding-left:200px;"> मिति : {{ \App\Helpers\TaskHelper::getNepaliDate($currentdate) }}</span><br>
                 <b>च.नं. :</b> 
                </div>
            ...
            <div class="row" style="margin-top:15px">
                <p style="text-align: center;font-weight:600;">विषय  :- खाता वन्द गरिदिने सम्वन्धमा । </p>
            </div>
            ...
            <div class="row" style="margin-left: 10px;margin-top:20px">
                <div class="col-md-12"> <p style="text-indent:3em;">   प्रस्तुत विषयमा यस रास्कोट नगरपालिका वडा नं स्थित <strong>{{ $plandetail->Name }}</strong>को नाममा त्यस वैकमा रहेको वैंक खाता
                    नं.<strong>{{ $plandetail->BankAccountNo }}</strong> वन्द गरिदिनु हुन सिफारिस साथ अनुरोध छ ।
                    </p>
                </div>
            </div>    
