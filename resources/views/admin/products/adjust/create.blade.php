		     	...
		     	{{ csrf_field() }}
		     	    ...
		     	    <div class="row">
	                   	...
	                   	<div class="col-md-4">
                            ...
                            {!! Form::select('location_id',[''=>'Select Location']+$location, null, ['class'=>'form-control']) !!}
	                   	</div>
	                   	<div class="col-md-4">
	                   ...
	                   <div class="col-md-4">
                           ...
                           {!! Form::select('ledgers_id',[''=>'Select Account']+$account_ledgers, null, ['class'=>'form-control','required' => 'required']) !!}
	                   </div>
