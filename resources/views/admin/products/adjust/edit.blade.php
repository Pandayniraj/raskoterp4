		     	...
		     	{{ csrf_field() }}   
		     	    ...
		     	    <div class="row"> 
	                   	...
	                   	<div class="col-md-4">
                            ...
                            {!! Form::select('location_id',[''=>'Select Location']+$location, $stock_adjustment->location_id, ['class'=>'form-control']) !!}
	                   	</div>
	                   	<div class="col-md-4">
	                   	    <label class="control-label">Reason</label>
                             {!! Form::select('reason',[''=>'Select Reason']+$reasons, $stock_adjustment->reason, ['class'=>'form-control']) !!}
	                   	</div>
	                   <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a href="javascript::void(0)" class="btn btn-default btn-xs" id="addMore" style="float: right;">
                                <i class="fa fa-plus"></i> <span>Add Inventroy Item</span>
                            </a>
                        </div>
                    </div>
...
function calcTotal()
{
    ...
    $('#taxable-amount').html(taxableAmount.toLocaleString());

    $('#total_tax_amount').val(tax_amount);

    $('#taxabletax').val(taxableTax);
    $('#taxable-tax').html(taxableTax.toLocaleString());
