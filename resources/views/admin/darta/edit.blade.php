        ...
        <form method="post" action="{{route('admin.darta.edit',$darta->id)}}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="darta_num" class="form-control input-sm" placeholder="दर्ता नम्बर..." required="" value="{{$darta->darta_num}}">
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="received_letter_num" class="form-control  input-sm" placeholder="प्राप्त पत्र नम्बर..." value="{{$darta->received_letter_num}}">
                      <div class="input-group-addon">
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="letter_date" class="form-control  input-sm datepicker" placeholder="पत्र मिति..." value="{{$darta->letter_date}}">
                      <div class="input-group-addon">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="subject" class="form-control  input-sm" placeholder="विषय..." required="" value="{{$darta->subject}}">
                      <div class="input-group-addon">
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                        {!! Form::select('sender_office_name',$users,$darta->sender_office_name,['class'=>'form-control searchable','placeholder'=>'पठाउने अधिकारीको नाम']) !!}
                      <div class="input-group-addon">
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                        {!! Form::select('receiving_officer_name',$users,$darta->receiving_officer_name,['class'=>'form-control searchable','placeholder'=>'प्राप्त गर्ने अधिकारीको नाम']) !!}
                      <div class="input-group-addon">
            ...
            <div class="row">
                  <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="received_date" class="form-control input-sm datepicker" placeholder="प्राप्त भएको मिति..." value="{{$darta->received_date}}">
                      <div class="input-group-addon">
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="remarks" class="form-control  input-sm" placeholder="टिप्पणीहरू..." value="{{$darta->remarks}}">
                      <div class="input-group-addon">
