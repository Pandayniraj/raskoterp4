                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered" id="orders-table">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-danger">
                                <td class="font-st">
                                    <a href="{{\FinanceHelper::get_entry_type_label($value->entry->entrytype_id)}}/{{$value->entry->id}}">{{  $value->number  }}</a>
                            ...
                            @foreach($bankingIncome as $key=>$value)
                             <tr>
                                 <td class="font-st">{{  $value->number  }} </td>
                                <td class="font-st">
                                <h5 class="font-st">
                        ...
                        <tr>
                            ...
                            <td class="font-st">{{number_format($cashIn,2)}}</td>
                            <td class="font-st">{{number_format($cashOut,2)}}</td>
                            <td colspan="2"></td>
                        </tr>
                        <tr>
                            <td></td>
                            ...
                            <th style="font-size: 16.5px" class="font-st">{{ number_format($cashIn - $cashOut,2) }}</th>
                        </tr>
                        </tfoot>
                    </table>
