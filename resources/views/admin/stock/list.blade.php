                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input required="" type="text" class="form-control datepicker date-toggle-nep-eng1" name="buying_date" value="@if( isset($stock)) {{ $stock->buying_date }}@endif" data-format="yyyy/mm/dd" data-parsley-id="6" placeholder="Buying Date">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <input type="text" class="form-control datepicker date-toggle-nep-eng1" name="service_date" value="@if(isset($stock)){{ $stock->service_date }}@endif" data-format="yyyy/mm/dd" data-parsley-id="6" placeholder="Service Date">
                                            <div class="input-group-addon">
                                                <a href="#"><i class="fa fa-calendar"></i></a>
                                            </div>
                                        </div>
