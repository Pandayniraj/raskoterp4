                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <div class="input-group">
                                    <input required="" type="text" class="form-control datepicker date-toggle-nep-eng1" name="return_date" value="Enter Return Date" data-format="yyyy/mm/dd" data-parsley-id="6">
