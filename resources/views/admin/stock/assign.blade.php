                ...
                <ul class="nav nav-tabs">
                    ...
                    <li>
                        <div class="pull-right hidden-print">
                            <a href="/admin/stock/generateAssignPdf" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="top" title="" data-original-title="PDF" target="_blank"><span><i class="fa fa-file-pdf-o"></i></span></a>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <div class="input-group">
                                    <input required="" type="text" class="form-control datepicker date-toggle-nep-eng1" name="assign_date" value="Enter Assign Date" data-format="yyyy/mm/dd" data-parsley-id="6">
