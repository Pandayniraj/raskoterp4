                        ...
                        <form role="form" id="sales_report" action="/admin/stock/report" method="post">
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control datepicker date-toggle-nep-eng1" name="start_date"
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control datepicker date-toggle-nep-eng1" name="end_date"
