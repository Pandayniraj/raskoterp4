        ...
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                ...
                <a class="btn btn-social btn-foursquare btn-sm" href="{!! route('admin.orders.create') !!}?type={{\Request::get('type')}}" title="Create Order">
                    ...
                    {!!  (isset($_GET['type']) && $_GET['type'] == 'po') ? 'Purchase Order' : ucfirst(isset($_GET['type']) ? $_GET['type'] : '' ) !!}
                </a>
                &nbsp;
                    ...
                    <table class="table table-hover table-bordered table-striped" id="orders-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="bg-warning">@if(\Request::get('type') == 'quotation'){{\FinanceHelper::getAccountingPrefix('QUOTATION_PRE')}}@else{{\FinanceHelper::getAccountingPrefix('SALES_PRE')}}@endif{!! $o->id !!}<input type="hidden" name="sale_id" class="index_sale_id" value="{{$o->id}}"></td>
                                ...
                                <td>@if(\Request::get('type') == 'quotation'){{\FinanceHelper::getAccountingPrefix('QUOTATION_PRE')}}@else{{\FinanceHelper::getAccountingPrefix('SALES_PRE')}}@endif{!! $o->id !!}<input type="hidden" name="sale_id" class="index_sale_id" value="{{$o->id}}"></td>
