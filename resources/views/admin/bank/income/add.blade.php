...
<div class="modal-content">
    <div id="printableArea">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6 form-group">
                        <label class="control-label">Bank Account</label>
                         ...
                         {!! Form::select('income_account',$account,null,['class'=>'form-control  ']) !!}
                        </div>
                    </div>
            ...
            <div class="tab-content">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 form-group">
                        ...
                        <div class="input-group col-sm-12">
                            <select class="form-group form-control " name="income_type" required=""
                            id='income_type'>
     ...
     {!! Form::select('received_via',$received_via,null,['class'=>'form-control   ']) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
