...
<section class="content-header" style="margin-top: -35px; margin-bottom: 20px">
            <h1>
               Import or Export Data for Customers
    ...
    <div class='row'>
        <div class='col-md-12 box'>
            <div class="box-body">
                ...
                <a href="{!! route('admin.download.customer.pdf.index') !!}"><button class="btn btn-info"> <i class="fa  fa-file-pdf-o">&nbsp;</i> PDF Export</button></a>
