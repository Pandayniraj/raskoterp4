...
<section class="content-header" style="margin-top: -35px; margin-bottom: 20px">
 ...
 <div class='row'>
   <div class='col-md-12'>
      <div class="box">
         <div class="box-body">
			<form method="post" action="{{route('household.field.store')}}">
				{{ csrf_field() }}
				<div class="row">
					...
					<div class="col-md-3 col-sm-12 form-group">
						...
						<input type="text" name="cultivated_area" class="form-control">
					</div>

					<div class="col-md-3 col-sm-12 form-group">
						<label class="control-label">क्षेत्रफलको इकाई (कठ्ठा/रोपनी)	</label>
						<input type="text" name="unit_of_area" class="form-control">
					</div>
