    ...
    <div class="modal-body wrap-modal wrap">
        <form role="form" id="training_form" action="/admin/trainings/save" method="post" enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <div class="input-group ">
                        <input type="text" name="start_date" id="start_date" value="@if(isset($training)){{$training->start_date}}@endif" class="form-control datepicker date-toggle-nep-eng1" required="">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <div class="input-group">
                        <input type="text" name="finish_date" id="finish_date" value="@if(isset($training)){{$training->finish_date}}@endif" class="form-control datepicker date-toggle-nep-eng1" required="">
                        <div class="input-group-addon">
                            <a href="#"><i class="fa fa-calendar"></i></a>
                        </div>
                    </div>
