            ...
            <div class="nav-tabs-custom">
                <div class="nav nav-tabs">
                    <ul class="nav nav-tabs">
                        <li @if(!\Request::segment(4)) class="active" @endif><a href="#template_list" data-toggle="tab"
                                                                                aria-expanded="true">Salary Template
                                List</a>
                        </li>
                        <li @if(\Request::segment(4)) class="active" @endif><a href="#new_template" data-toggle="tab"
                                                                               aria-expanded="false">Set Salary
                                Template</a>
                        </li>
                    </ul>
                </div>
                <div class="tab-content bg-white">
                    ...
                    <div class="tab-pane @if(!\Request::segment(4)) active @endif" id="template_list"
                                            ...
                                            @foreach($templates as $tk => $tv)
                                                ...
                                                <!-- <td>{{ $tv->overtime_salary }}</td> -->
                                                    <td style="text-align:right;">
                                                        <a href="/admin/payroll/salary_template_details/{{ $tv->salary_template_id }}"
                                                           class="btn btn-info btn-xs" title="" data-toggle="modal"
                                                           data-target="#template_show" data-placement="top"
                                                           data-original-title="Show"><i class="fa fa-list"></i></a>
                                                        <a href="/admin/payroll/salary_template/{{ $tv->salary_template_id }}"
                                                           class="btn btn-primary btn-xs" title="" data-toggle="tooltip"
                                                           data-placement="top" data-original-title="Edit"><i
                                                                class="fa fa-edit"></i></a>
                                                        <a href="/admin/payroll/salary_template_delete/{{ $tv->salary_template_id }}"
                    ...
                    <div class="tab-pane @if(\Request::segment(4)) active @endif" id="new_template"
                         style="position: relative;">
                        <form action="/admin/payroll/salary_template" method="post"
                              class="form-horizontal form-groups-bordered" id="save_template">
                            {{ csrf_field() }}
                            <?php
                            $total_salary = 0;
                            $total_allowance = 0;
                            ...
                            <div class="row">
                                <div class="form-group" id="border-none">
                                    <label for="field-1" class="col-sm-3 control-label">Salary Grades<span
                                            class="required"> *</span></label>
                                    <div class="col-sm-5">
                                        <input type="text" name="salary_grade"
                                               value="@if($salaryTemplate){{ $salaryTemplate->salary_grade }}@endif"
                                               class="form-control" required="" placeholder="Enter Salary Grades"
                                               data-parsley-id="4">
                                    </div>
                                </div>
                                <div class="form-group" id="border-none">
                                    <label for="field-1" class="col-sm-3 control-label">Basic Salary<span
                                            class="required"> *</span></label>
                                    <div class="col-sm-5">
                                        <input type="text" data-parsley-type="number" name="basic_salary"
                                               value="@if($salaryTemplate){{ $salaryTemplate->basic_salary }}@endif"
                                               class="salary form-control" required="" placeholder="Enter Basic Salary"
                                               data-parsley-id="6">
                                    </div>
                                </div>
                                {{-- <div class="form-group" id="border-none">
                                ...
                                <div class="col-sm-12">
                                    <div class="panel panel-custom">
                                        ...
                                        <div class="panel-body" style="padding-top: 0;">
                                            ...
                                            {{--                                            <input type="text" data-parsley-type="number" name="other_allowance" value="" class="salary form-control" data-parsley-id="10">--}}
                                            {{--                                        </div>--}}
                                            {{--                                        <div class="">--}}
                                            {{--                                            <label class="control-label">D. Allowance </label>--}}
                                            {{--                                            <input type="text" data-parsley-type="number" name="da" value="" class="salary form-control" data-parsley-id="12">--}}
                                            {{--                                        </div>--}}
                                            {{--                                      @endif--}}
                                            ...
                                            <div class="row">
                                                @foreach($allowances as $ak => $av)
                                                    ...
                                                    <div class="col-md-6"
                                                         style="margin-top: 12px;padding-left: 25px;padding-right: 25px">
                                                        <div>
                                                            <label for="">{{$av['allowance_label'] }}</label>
                                                            <input type="hidden" class="form-control input-sm" readonly
                                                                   name="allowance_label[]"
                                                                   value="{{ $av['allowance_label'] }}"
                                                                   data-parsley-id="10">
                                                        </div>
                                                        <div>
                                                            <input type="number" data-parsley-type="number"
                                                                   name="allowance_value[]"
                                                                   value="{{ $av['allowance_value'] }}"
                                                                   class="salary form-control input-sm"
                                                                   data-parsley-id="12">
                                                        </div>
                                                        <input type="hidden" name="salary_allowance_id[]"
                                                               value="{{ $av->salary_allowance_id }}"
                                                               class="form-control">
                                                    </div>
                            ...
                            <div class="row">
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    {{-- <th class="col-sm-8 vertical-td"><strong>Gross Salary :</strong>
                                                     ...
                                                     <td class="">
                                                         <input type="text" name="" disabled="" value="{{ $total_salary + $total_allowance }}" id="total" class="form-control" data-parsley-id="18">
                                                     </td> --}}
                                                </tr>
                                                <!-- / Sub total -->
                                                {{-- <tr>
                                                ...
                                                <tr>
                                                    <!-- Grand Total -->
                                                    <th class="col-sm-8 vertical-td"><strong>Total Salary :</strong>
                                                    </th>
                                                    <td class="">
                                                        <input type="text" name="" disabled="" required=""
                                                               value="{{ $total_salary + $total_allowance - $total_deduction }}"
                                ...
                                @if(\Request::segment(4))
                                    <input type="hidden" name="salary_template_id" class="form-control"
                                           value="{{ \Request::segment(4) }}"/>
                                @endif

                                <div class="clearfix"></div>
                                <div class="col-sm-2 margin pull-right">
                                    <a href="/admin/payroll/salary_template" type="button"
                                       class="btn btn-default btn-block">Cancel</a>
                                </div>

                                <div class="col-sm-6 margin pull-right">
                                    <button type="submit" class="btn btn-primary btn-block"
                                            id="create_template_btn">@if(\Request::segment(4)) Update @else
                                            Create @endif</button>
                                </div>
