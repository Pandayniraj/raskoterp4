                                       ...
                                       <td class="bg-info">
                                        ...
                                        <td class="bg-info" style="text-align: left;">
                                            ...
                                            <a href="/admin/leads/{{$lead->id}}?type={{\Request::get('type')}}">{{$lead->name}}
                                               {{$lead->company->name}}</a></h4>
                                            @if(strtolower($lead->rating) != 'active')  @endif
                                        </td>

                                        <td class="bg-info">
                                            {!! \Form::select('stage_id', $stages, $lead->stage_id, ['class' => 'form-control label-default', 'id' => 'index_stage_id'])!!}
                                        </td>
                                        ...
                                        @else
                                        <td class="bg-{{$lead->stage->color}}" >{!! \Form::checkbox('chkLead[]', $lead->id) !!}</td>

                                        <td class="bg-{{$lead->stage->color}}">
                                        <input type="hidden" name="lead_id" class="index_lead_id" value="{{$lead->id}}"></td>

                                        <td class="bg-{{$lead->stage->color}}">{{ env('APP_CODE')}}{{ $lead->id }}</td>

                                        <td style="float:" class="bg-{{$lead->stage->color}}">
                                            @if(strtolower($lead->rating) != 'active')  @endif
