...
<section class="content-header" style="margin-top: -35px; margin-bottom: 20px">
 ...
 <div class='row'>
   <div class='col-md-12'>
      <div class="box">
         <div class="box-body">
        <form method="post" action="{{route('extra.update', $findextra->Id)}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-md-3 col-sm-12 form-group">
                    <label class="control-label">क्षेत्र (फिल्ड)को नेपाली नाम</label>
                    <div class="input-group">
                      <input type="text" name="nepaliname" value="{{$findextra->Name}}" class="form-control input-sm" required="">
                 ...
                 <div class="col-md-3 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <select name="status" class="form-control">
                        <option value=1 {{( $findextra->IsEnable == 1) ? "selected":""}}>छ</option>
                        <option value=0 {{( $findextra->IsEnable == 0) ? "selected":""}}>छैन</option>
                      </select>
                      <div class="input-group-addon">
         ...
         <div class="row">
                    <div class="col-md-12 ">
                        ...
                        <div class="form-group pull-right">
                            ...
                            <a href="/admin/extra/" title="{{ trans('general.button.cancel') }}" class='btn btn-default'>{{ trans('general.button.cancel') }}</a>
                        </div>
                      </div>
                 </div>
    </form>
