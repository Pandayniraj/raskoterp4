...
<section class="content-header" style="margin-top: -35px; margin-bottom: 20px">
 ...
 <div class='row'>
   <div class='col-md-12'>
      <div class="box">
         <div class="box-body">
        <form method="post" action="{{ route('area.update', $findarea->Id)}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="name" class="form-control input-sm" value="{{ $findarea->Name }}" placeholder="Date..." required="">
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="amount" class="form-control  input-sm" value="{{ $findarea->Amount }}" placeholder="Letter Number...">
                      <div class="input-group-addon">
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <select name="status" class="form-control">
                        <option value=1 {{ ($findarea->IsEnable == 1) ? "selected":"" }}>छ</option>
                        <option value=0 {{ ($findarea->IsEnable == 0) ? "selected":"" }}>छैन</option>
                      </select>
                      <div class="input-group-addon">
         ...
         <div class="row">
                    <div class="col-md-12 ">
                        ...
                        <div class="form-group pull-right">
                            ...
                            <a href="/admin/area/" title="{{ trans('general.button.cancel') }}" class='btn btn-default'>Cancel</a>
                        </div>
                        </div>
                 </div>
    </form>
