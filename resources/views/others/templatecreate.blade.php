            ...
            <div class="row">
                <div class="col-md-3 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="template" class="form-control input-sm" placeholder="Code number..." required="">
                 ...
                 <div class="col-md-3 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="subject" class="form-control  input-sm" placeholder="Post...">
                      <div class="input-group-addon">
                ...
                <div class="col-md-3 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="sn" class="form-control  input-sm" placeholder="Serial number...">
                      <div class="input-group-addon">
                            <a href="#"><i class="fa  fa-sort-amount-desc"></i></a>
                        </div>
                    </div>
                ...
                <div class="col-md-12 col-sm-12 form-group">
                   ...
                   <div class="input-group">
                    <textarea id='body' class="form-control textarea" name="detail" rows="4" cols="50"></textarea> 
                     <div class="input-group-addon">
                           <a href="#"><i class="fa  fa-calendar"></i></a>
                       </div>
                   </div>
