...
<section class="content-header" style="margin-top: -35px; margin-bottom: 20px">
 ...
 <div class='row'>
   <div class='col-md-12'>
      <div class="box">
         <div class="box-body">
        <form method="post" action="{{route('tax.update', $findtax->Id)}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-md-3 col-sm-12 form-group">
                    <label class="control-label">संकेत नं.</label>
                    <div class="input-group">
                      <input type="text" name="signnum" value="{{ $findtax->Alias}}" class="form-control input-sm" required="">
                 ...
                 <div class="col-md-3 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="taxname" value="{{ $findtax->Name}}" class="form-control  input-sm">
                      <div class="input-group-addon">
                ...
                <div class="col-md-3 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="sn" value="{{ $findtax->Sortkey}}" class="form-control  input-sm">
                      <div class="input-group-addon">
                            <a href="#"><i class="fa  fa-sort-amount-desc"></i></a>
                        </div>
                    </div>
                ...
                <div class="col-md-3 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="rate" value="{{ $findtax->Rate}}" class="form-control  input-sm">
                      <div class="input-group-addon">
                            <a href="#"><i class="fa  fa-sort-amount-desc"></i></a>
                        </div>
                    </div>
                 ...
                 <div class="col-md-3 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <select name="status" class="form-control">
                        <option value=1 {{ ($findtax->IsEnable == 1) ? "selected":""}}>छ</option>
                        <option value=0 {{ ($findtax->IsEnable == 0) ? "selected":""}}>छैन</option>
                      </select>
                      <div class="input-group-addon">
