...
<div class='row'>
    <div class='col-md-12'>
        <div class="box">
            <div class="box-body">
                <form method="post" action="{{route('activitiesmgmt.store')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12 form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="activities" class="form-control input-sm" value="" required="">
                                <div class="input-group-addon">
                                    <a href="#"><i class="fa  fa-sort-numeric-asc"></i></a>
                                </div>
                            </div>
