        ...
        <div class='row'>
            <div class='col-md-12'>
                ...
                <div style="display: inline;">
                    <a class="btn btn-primary btn-sm" title="Create New Ticket" href="{{ route('tax.create') }}">
        ...
        <div class="tab-responsive">
               ...
               @foreach ($taxes as $key => $tax )
                    <tr>
                        ...
                        <td>
                            <a href="{!! route('tax.edit', $tax->Id) !!}" title="{{ trans('general.button.edit') }}"><i class="fa fa-edit"></i></a>
                            <a href="{!! route('tax.delete', $tax->Id) !!}" onclick="return confirm('Are you sure you want to delete this item?');" title="{{ trans('general.button.delete') }}"><i class="fa fa-trash deletable"></i></a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
