...
<div class='row'>
  <div class='col-md-12'>
    <div class="box">
      <div class="box-body">
        <form method="post" action="{{route('appropriation.store')}}" enctype="multipart/form-data">
            {{ csrf_field() }}
              <div class="row">
                <div class="col-md-4 col-sm-12 form-group">
                  <label class="control-label">विनियोजन किसिम</label>
                    <div class="input-group">
                      <input type="text" name="appropriation" class="form-control input-sm" placeholder="Appropriation..." required="">
                ...
                <div class="col-md-4 col-sm-12 form-group">
                  <label class="control-label">
                    विवरण</label>
                    <div class="input-group">
                      <input type="text" name="detail" class="form-control  input-sm" placeholder="Detail...">
                        <div class="input-group-addon">
