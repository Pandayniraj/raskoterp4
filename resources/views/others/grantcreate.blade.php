...
<section class="content-header" style="margin-top: -35px; margin-bottom: 20px">
 ...
 <div class='row'>
   <div class='col-md-12'>
      <div class="box">
         <div class="box-body">
        <form method="post" action="{{route('grant.store')}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="grant" value="" class="form-control input-sm" placeholder="Grant..." required="">
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                    <label class="control-label">
                        विवरण</label>
                    <div class="input-group">
                      <input type="text" name="detail" value="" class="form-control  input-sm" placeholder="Detail...">
                      <div class="input-group-addon">
