...
<section class="content-header" style="margin-top: -35px; margin-bottom: 20px">
 ...
 <div class='row'>
   <div class='col-md-12'>
      <div class="box">
         <div class="box-body">
        <form method="post" action="{{ route('grant.update', $findgrant->Id)}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-md-4 col-sm-12 form-group">
                    <label class="control-label">अनुदानको नाम</label>
                    <div class="input-group">
                      <input type="text" name="grant" value="{{ $findgrant->Name}}" class="form-control input-sm" placeholder="Grant..." required="">
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                    <label class="control-label">
                        विवरण</label>
                    <div class="input-group">
                      <input type="text" name="detail" value="{{ $findgrant->Remarks}}" class="form-control  input-sm" placeholder="Detail...">
                      <div class="input-group-addon">
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <select name="status" class="form-control">
                        <option value=1 {{ ($findgrant->IsEnable == 1) ? "selected":"" }}>छ</option>
                        <option value=0 {{ ($findgrant->IsEnable == 0) ? "selected":"" }}>छैन</option>
                      </select>
                      <div class="input-group-addon">
         ...
         <div class="row">
                    <div class="col-md-12 ">
                        ...
                        <div class="form-group pull-right">
                            ...
                            <a href="/admin/grantmgmt/" title="{{ trans('general.button.cancel') }}" class='btn btn-default'>{{ trans('general.button.cancel') }}</a>
                        </div>
                      </div>
                 </div>
