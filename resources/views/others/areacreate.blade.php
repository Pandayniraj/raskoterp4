            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="name" class="form-control input-sm" placeholder="Area..." required="">
         ...
         <div class="row">
                    <div class="col-md-12 ">
                        ...
                        <div class="form-group pull-right">
                            ...
                            <a href="/admin/area/" title="{{ trans('general.button.cancel') }}" class='btn btn-default'>{{ trans('general.button.cancel') }}</a>
                        </div>
                      </div>
                 </div>
