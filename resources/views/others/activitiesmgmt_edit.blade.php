...
<div class='row'>
    <div class='col-md-12'>
        <div class="box">
            <div class="box-body">
                <form method="post" action="{{route('activitiesmgmt.update', $findactivity->Id)}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row">
                            ...
                            <div class="input-group">
                                <select name="area" class="form-control">
                                    ...
                                    @foreach ($areas as $key => $area )
                                        <option value="{{ $area->Id}}" {{ ($findactivity->SubjectAreaId == $area->Id) ? "selected":""}}>{{ $area->Name}}</option>
                                    @endforeach
                            ...
                            <div class="input-group">
                                <select name="subarea" class="form-control">
                                    ...
                                    @foreach ($subareas as $key => $subarea )
                                        <option value="{{ $subarea->Id}}" {{ ($findactivity->SubjectTypeId == $subarea->Id) ? "selected":""}}>{{ $subarea->Name}}</option>
                                    @endforeach
                                </select>
                                <div class="input-group-addon">
                                    <a href="#"><i class="fa  fa-sort-numeric-asc"></i></a>
                        ...
                        <div class="col-md-4 col-sm-12 form-group">
                            <label class="control-label">मुख्य कार्यक्रम/क्रियाकलापको नाम</label>
                            <div class="input-group">
                                <input type="text" name="activities" class="form-control input-sm" value="{{ $findactivity->Name}}" required="">
                                <div class="input-group-addon">
                                    <a href="#"><i class="fa  fa-sort-numeric-asc"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-12 form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="amount" class="form-control  input-sm" value="{{ $findactivity->Amount}}" placeholder="Letter Number...">
                                <div class="input-group-addon">
                        ...
                        <div class="col-md-3 col-sm-12 form-group">
                            ...
                            <div class="input-group">
                                <select name="status" class="form-control">
                                    <option value=1 {{ ($findactivity->IsEnable == 1) ? "selected":""}}>छ</option>
                                    <option value=0 {{ ($findactivity->IsEnable == 0) ? "selected":""}}>छैन</option>
                                </select>
                    ...
                    <div class="row">
                        <div class="col-md-12 ">
                            ...
                            <div class="form-group pull-right">
                                ...
                                <a href="/admin/activitiesmgmt/" title="{{ trans('general.button.cancel') }}" class='btn btn-default'>{{ trans('general.button.cancel') }}</a>
                            </div>
                        </div>
                    </div>
