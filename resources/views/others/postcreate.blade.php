            ...
            <div class="row">
                <div class="col-md-3 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="codenum" class="form-control input-sm" placeholder="Code number..." required="">
                 ...
                 <div class="col-md-3 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="post" class="form-control  input-sm" placeholder="Post...">
                      <div class="input-group-addon">
