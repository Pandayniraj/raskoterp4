...
<section class="content-header" style="margin-top: -35px; margin-bottom: 20px">
 ...
 <div class='row'>
   <div class='col-md-12'>
      <div class="box">
         <div class="box-body">
        <form method="post" action="{{route('subarea.update', $findsubarea->Id)}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                ...
                <div class="col-md-3 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                        <select name="area" class="form-control">
                            ...
                            {{$area->Id, $findsubarea->SubjectAreaId}}
                            <option value="{{$area->Id}}"{{ ($findsubarea->SubjectAreaId == $area->Id) ? "selected":"" }}>{{$area->Name}}</option>
                            @endforeach
                        </select>
                      {{-- <input type="text" name="date" class="form-control input-sm" placeholder="Date..." required=""> --}}
                ...
                <div class="col-md-3 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="subarea" value="{{ $findsubarea->Name}}" class="form-control input-sm" placeholder="Date..." required="">
                      <div class="input-group-addon">
                            <a href="#"><i class="fa  fa-sort-numeric-asc"></i></a>
                        </div>
                    </div>
                 ...
                 <div class="col-md-3 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="amount" class="form-control  input-sm" value="{{ $findsubarea->Amount}}" placeholder="Letter Number...">
                      <div class="input-group-addon">
                 ...
                 <div class="col-md-3 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                        <select name="status" class="form-control">
                            <option value="" disabled>Select Any One</option>
                            <option value=1 {{ ($findsubarea->IsEnable == 1) ? "selected":"" }}>छ</option>
                            <option value=0 {{ ($findsubarea->IsEnable == 0) ? "selected":"" }}>छैन</option>
                        </select>
                      <div class="input-group-addon">
