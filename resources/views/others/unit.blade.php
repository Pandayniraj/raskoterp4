        ...
        <div class='row'>
            <div class='col-md-12'>
                ...
                <div style="display: inline;">
                    <a class="btn btn-primary btn-sm" title="Create New Ticket" href="{{ route('unit.create') }}">
        ...
        <div class="tab-responsive">
               ...
               @foreach ($units as $key => $unit )
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{!! route('unit.edit', $unit->Id) !!}" title="{{ trans('general.button.edit') }}"><i class="fa fa-edit"></i></a>
                            <a href="{!! route('unit.delete', $unit->Id) !!}" onclick="return confirm('Are you sure you want to delete this item?');" title="{{ trans('general.button.delete') }}"><i class="fa fa-trash deletable"></i></a>
                        </td>
                    </tr>
                    @endforeach
            </tbody>
