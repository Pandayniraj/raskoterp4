...
<section class="content-header" style="margin-top: -35px; margin-bottom: 20px">
    <h1>
        {{ $page_title }}
        <small>विनियोजन किसिम व्यवस्थापन</small>
    </h1>
        ...
        <div class='row'>
            <div class='col-md-12'>
                ...
                <div style="display: inline;">
                    <a class="btn btn-primary btn-sm" title="Create New Ticket" href="{{ route('appropriation.create') }}">
                ...
                <tbody>
                    @foreach ($appropriations as $key => $appropriation )
                        ...
                        <tr>
                            ...
                            <td>{{ $appropriation->Remarks}}</td>
                            <td>
                                @if($appropriation->IsEnable == 1)
                                true
                                @else
                                false
                                @endif
                            ...
                            <td>
                                <a href="{!! route('appropriation.edit', $appropriation->Id) !!}" title="{{ trans('general.button.edit') }}"><i class="fa fa-edit"></i></a>
                                <a href="{!! route('appropriation.delete', $appropriation->Id) !!}" onclick="return confirm('Are you sure you want to delete this item?');" title="{{ trans('general.button.delete') }}"><i class="fa fa-trash deletable"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
