...
<section class="content-header" style="margin-top: -35px; margin-bottom: 20px">
 ...
 <div class='row'>
   <div class='col-md-12'>
      <div class="box">
         <div class="box-body">
        <form method="post" action="{{route('plantransfer.update', $findplan->Id)}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                        <select name="planfromid" id="planid" class="form-control">
                            ...
                            <option value="{{ $register->Id}}" {{($findplan->PlanFromId == $register->Id) ? "selected":""}} data-amount="{{ $register->appropriationamt }}" >{{$register->name}}</option>
                            @endforeach
                        </select>
                 ...
                 <div class="col-md-2 col-sm-12 form-group">
                    <label class="control-label"> 
                        विनियोजन रकम</label>
                    <div class="input-group">
                        <input type=text id="amountid" value="{{ $findplan->FromAmount}}" class="form-control input-sm" name="appropriationamt">
                      <div class="input-group-addon">
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                        <select name="planto" class="form-control">
                            <option value="" disabled selected> Select Any One</option>
                            @foreach ($registers as $register )
                            <option value="{{ $register->Id}}" {{($findplan->PlanToId == $register->Id) ? "selected":""}}>{{$register->name}}</option>
                            @endforeach
                        </select>
                      <div class="input-group-addon">
                ...
                <div class="col-md-2 col-sm-12 form-group">
                   ...
                   <div class="input-group">
                      <input type="text" name="amountto" value="{{ $findplan->ToAmount}}" class="form-control input-sm">
                     <div class="input-group-addon">
                           <a href="#"><i class="fa  fa-calendar"></i></a>
                       </div>
                   </div>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                        <input type="text" value="{{ $findplan->TransDate}}" class="form-control input-sm datepicker" name="miti">
                      <div class="input-group-addon">
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                         <input type="text" name="description" value="{{ $findplan->Description}}" class="form-control  input-sm">
                      <div class="input-group-addon">
                ...
                <div class="col-md-4 col-sm-12 form-group">
                   ...
                   <div class="input-group">
                       <input type="text" name="remark" value="{{ $findplan->Remarks}}" class="form-control input-sm">
