    ...
    <div class="tab-content">
        <div class='row tab-pane fade' id="plan">
            <div class='col-md-12'>
                <div class="box">
                    <div class="box-body">
                        <form method="post" action="{{ route('plan.update', $findplan->Id) }}"
        ...
        <div class='row tab-pane fade in active' id="lagatanuman">
            <div class='col-md-12'>
                <div class="box">
                    <div class="box-body">
                        <form method="post" action="{{ route('costestimate.update', $findcost[0]->id) }}"
                            enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="row">
        ...
        <div class='row tab-pane fade' id='yojana'>
            <div class="box">
                <div class="box-body">
                    <form method="post" action="{{ route('planagreement.update', $findagreement[0]->id) }}"
                        enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-3 col-sm-12 form-group">
                        ...
                        <p style="color:blue;">चिट्ठी पत्रको नमुना</p>
                            <div class="col-md-3">
                                <a href="{{ route('admin.plan.option.one',$findplan->Id) }}"><i class="fa fa-file-text" aria-hidden="true">योजना सम्झौता फारम</i></a>
                            </div>
                            <div class="col-md-3">
                                <a href="{{ route('admin.plan.option.two',  $findplan->Id) }}"><i class="fa fa-file-text" aria-hidden="true">बैंक खाता फुकुवा</i><a href="#"></a>
                            </div>
                            <div class="col-md-3">
                                <a href="{{ route('admin.plan.option.three',  $findplan->Id)  }}"><i class="fa fa-file-text" aria-hidden="true">सम्झौताको कार्यादेश</i></a>
                            </div>
                            <div class="col-md-3">
                                <a href="{{ route('admin.plan.option.four',  $findplan->Id) }}"> <i class="fa fa-file-text" aria-hidden="true">बैंक खाता खाेल्ने सम्वन्धमा</i></a>
                            </div>
                            <div class="col-md-3">
                              <a href="{{ route('admin.plan.option.five', $findplan->Id) }}"><i class="fa fa-file-text" aria-hidden="true">बैंक खाता संचालक परिवर्तन</i></a>
                            </div>
                            <div class="col-md-3">
                                <a href="{{ route('admin.plan.option.six', $findplan->Id) }}"> <i class="fa fa-file-text" aria-hidden="true" style="margin-right:3px;">बैंक खाता वन्द</i></a>
                            </div>
                        </div>   
                        <div class="row">
                            <div class="col-md-12 ">
        ...
        <div class='row tab-pane fade' id='extensiondetails'>
            <div class="box">
                <div class="box-body">
                    <form method="post" action="{{ route('pmsagreed.extension.update', $findagreement[0]->id) }}"
                        enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('patch') }}
                        <div class="row">
        ...
        <div class="row tab-pane fade" id="aarthic">
            <div class="box">
                <div class="box-body">
                    <form method="post" action="{{ route('pms.financial.transaction') }}"
                        enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <!-- {{ method_field('patch') }} -->
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-12 form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="paymentamt" placeholder="Payment Amount...."
                                        class="form-control">
                            ...
                            <div class="col-md-2 col-sm-12 form-group">
                                ...
                                <input type="text" name="remainingamt" placeholder="Remaining Amount...."
                                    class="form-control">

                            </div>
                            <div class="col-md-2 col-sm-12 form-group">
                                <label class="control-label">अवस्था</label>
                                <select name="prjcondition" class="form-control">
