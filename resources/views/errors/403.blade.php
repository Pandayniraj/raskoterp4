...
@section('content')
    ...
    <div class="box-body">
    	<li> The Feature might not have been enabled for your organization</li>
    	<li> The Feature might not have been enabled for your roles</li>
        <li>{{ trans('general.error.403-explanation') }}</li>
    </div>
@endsection
