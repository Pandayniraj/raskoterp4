...
<section class="content-header" style="margin-top: -35px; margin-bottom: 20px">
 ...
 <div class='row'>
   <div class='col-md-12'>
      <div class="box">
        <div class="box-body">
        <form method="post" action="{{route('program.update', $findprogram->id)}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">

                <div class="col-md-4 col-sm-12 form-group">
                    <label class="control-label">कार्यक्रम</label>
                    <div class="input-group">
                        <input type="text" name="name" value="{{ $findprogram->name}}" class="form-control input-sm">
