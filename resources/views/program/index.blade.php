        ...
        <div class='row'>
            <div class='col-md-12'>
                ...
                <div style="display: inline;">
                    <a class="btn btn-primary btn-sm" title="Create New Ticket" href="{{ route('program.create') }}">
        ...
        <div class="tab-responsive">
               ...
               @foreach ($programs as $key => $program)
                    <tr>
                        ...
                        <td>{{ $program->name}}</td>
                        <td>
                            <a href="{!! route('program.edit', $program->id) !!}" title="{{ trans('general.button.edit') }}"><i class="fa fa-edit"></i></a>
                            <a href="{!! route('program.delete', $program->id) !!}" onclick="return confirm('Are you sure you want to delete this item?');" title="{{ trans('general.button.delete') }}"><i class="fa fa-trash deletable"></i></a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
